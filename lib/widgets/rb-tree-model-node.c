/*
 *  arch-tag: Implementation of GtkTreeModel wrapper of RBNode objects
 *
...
rb_tree_model_node_column_get_type (void)
{
	...
	if (etype == 0)
	{
		static const GEnumValue values[] =
		{
			...
			{ RB_TREE_MODEL_NODE_COL_TRACK_NUMBER_STR, "RB_TREE_MODEL_NODE_COL_TRACK_NUMBER_STR", "track number (string format)" },
