/* 
 *  arch-tag: Querying tests for the RhythmDB tree database
 *
...
main (int argc, char **argv)
{
	...
	rhythmdb_do_full_query (db, &main_model, &genre_model,
				&artist_model, &album_model,
				RHYTHMDB_QUERY_PROP_EQUALS,
				RHYTHMDB_PROP_NAME, "Angel",
				RHYTHMDB_QUERY_DISJUNCTION,
				RHYTHMDB_QUERY_PROP_EQUALS,
				RHYTHMDB_PROP_NAME, "Sin",
				RHYTHMDB_QUERY_DISJUNCTION,
				RHYTHMDB_QUERY_PROP_EQUALS,
				RHYTHMDB_PROP_NAME, "Head Like A Hole",
				RHYTHMDB_QUERY_DISJUNCTION,
				RHYTHMDB_QUERY_PROP_EQUALS,
				RHYTHMDB_PROP_NAME, "Killa Bees",
				RHYTHMDB_QUERY_END);
