...
void              rb_shell_clipboard_set_clipboard (RBShellClipboard *shell_clipboard,
					            RBViewClipboard *clipboard);

RBViewClipboard  *rb_shell_clipboard_get_clipboard (RBShellClipboard *shell_clipboard);
